...
public class TraceContextCorrelationCore {
    ...
    public static <Res> void resolveCorrelationForResponse(Res response,
    ...
    private static <Res> void addTargetAppIdInResponseHeaderViaRequestContext(Res response,
        ...
        responseHeaderSetter
                .addHeader(response, REQUEST_CONTEXT_HEADER_NAME, REQUEST_CONTEXT_HEADER_APPID_KEY + "=" + appId);
    }
